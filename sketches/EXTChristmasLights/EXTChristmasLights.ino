 ...
 *             
 *       Exterior Christmas Light Controller
 * *******************************************************
 * 
 * COMPILE OPTIONS:
 *   WiON or ECOPlug
 ...
 * *******************************************************
 * 
 * Device: Woods WiOn | Model 50049
 * Description:
 *    Outdoor Wi-Fi Outlet
 *    Dual Outlet. 15A Max.
 * 
...
const char*       MQTT_CLIENT_ID    = "MQTT-EXTCHRISTMASLIGHTS";
...
// MQTT: topics
const char*       TOPIC_RELAY_STATUS         = "exterior/extchristmaslights/status";
const char*       TOPIC_RELAY_COMMAND        = "exterior/extchristmaslights/switch";
