...
const char*       MQTT_CLIENT_ID    = "MQTT-MAINGROWLIGHTS";
...
// MQTT: topics
const char*       TOPIC_RELAY_STATUS         = "firstfloor/maingrowlights/status";
const char*       TOPIC_RELAY_COMMAND        = "firstfloor/maingrowlights/switch";
