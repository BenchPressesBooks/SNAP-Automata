 ...
 *             Software Revision: 1.52
 *             
 *            Guest Bedroom Surge Strip
 * *******************************************************
 * 
 * COMPILE OPTIONS:
 *   WiON or ECOPlug
...
const char*       MQTT_CLIENT_ID    = "MQTT-GBRSURGESTRIP";
...
// MQTT: topics
const char*       TOPIC_RELAY_STATUS         = "secondfloor/gbrsurgestrip/status";
const char*       TOPIC_RELAY_COMMAND        = "secondfloor/gbrsurgestrip/switch";
