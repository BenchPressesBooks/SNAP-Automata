 ...
 *             Software Revision: 1.53
 *             
 *            Master Bedroom Surge Strip
 * *******************************************************
 * 
 * COMPILE OPTIONS:
 *   WiON or ECOPlug
 ...
 * *******************************************************
 * 
 * Device: Woods WiOn | Model 50051
 * Description:
 *    Indoor Wi-Fi Surge Protector. 125v. 15A General, 8.3A Ballast
 * 
 * Enabled Hardware Capabilities:
 *    Power Monitoring (Not enabled/working at this time)
 *    Indicator Light
 *    Relay
 *    Bypass Button
 * 
...
const char*       MQTT_CLIENT_ID    = "MQTT-MBRSURGESTRIP";
...
// MQTT: topics
const char*       TOPIC_RELAY_STATUS         = "secondfloor/mbrsurgestrip/status";
const char*       TOPIC_RELAY_COMMAND        = "secondfloor/mbrsurgestrip/switch";
