/*
 * *******************************************************
 *          Sonoff S20 Device Deployment
 *             Software Revision: 1.21
 *             
 *              SECONDARY GROW LIGHTS
 * *******************************************************
 * 
 * COMPILE OPTIONS:
 *   Sonoff Devices
 ...
 * 
 * CONNECTION NOTES:
 *   FTDI Pins are NOT swapped
 *     TX => TX
 *     RX => RX
 * 
 * *******************************************************
 * 
 * Device: Sonoff | Model S20
 * Description:
 *    WiFi Smart Socket. 90-250v. 10A
 * 
...
const char*       MQTT_CLIENT_ID    = "MQTT-SECONDARYGROWLIGHTS";
...
// MQTT: topics
const char*       TOPIC_RELAY_STATUS         = "firstfloor/secondarygrowlights/status";
const char*       TOPIC_RELAY_COMMAND        = "firstfloor/secondarygrowlights/switch";
...
// Pin configuration
const uint8_t     RELAY_PIN       = 12; // LOW is off
const uint8_t     BYPASS_PIN      = 0; // HIGH is unpressed
const uint8_t     LED_PIN         = 13;  // HIGH is off
