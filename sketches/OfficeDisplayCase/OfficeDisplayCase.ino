...
const char*       MQTT_CLIENT_ID    = "MQTT-OFFICEDISPLAYCASE";
...
// MQTT: topics
const char*       TOPIC_RELAY_STATUS         = "secondfloor/officedisplaycase/status";
const char*       TOPIC_RELAY_COMMAND        = "secondfloor/officedisplaycase/switch";
